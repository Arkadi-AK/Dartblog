...
class Post(models.Model):
    ...
    category = models.ForeignKey(Category, on_delete=models.PROTECT,
                                 related_name='posts')  # Если класс Category выше данного класса, то писать без кавычек, если ниже этого класса то 'Category'
    ...
    class Meta:
        ordering = ['-created_at']  # Сортировка по полю created_at, свежие будут выше
        verbose_name = 'Статья'
